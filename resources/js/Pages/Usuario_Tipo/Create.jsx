                ...
                <div className="contenedorReserva">
                    <div className='contenedorFormulario'>
                        <form onSubmit={handleSubmit} className='formulario' encType="multipart/form-data">
                            <h1 className="titulo">Crea un nuevo tipo de usuario</h1>
                            ...
                            <button type="submit" disabled={processing} className='botonFormulario'>Crear tipo de usuario</button>
                        </form>
                    </div>
                </div>
            </div>
